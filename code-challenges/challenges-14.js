...
const replaceWords = (str) => {
    ...
    if (strArr.indexOf(`I`) !== -1) {
        strArr.splice((strArr.indexOf(`I`)), 1, 'We');
    }
    if (strArr.indexOf(`was`) !== -1) {
        strArr.splice(strArr.indexOf(`was`), 1, 'were');
    }
    if (strArr.indexOf(`am`) !== -1) {
        strArr.splice(strArr.indexOf(`am`), 1, 'are');
    }
    return strArr.join(' ')
}
// -------------------------------------------------------------------------------------------------------
